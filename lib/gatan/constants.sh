...
readonly GATAN_SUDO_PROMPT='[gatan] Administrator password: '
readonly GATAN_METRICS_REFRESH_INTERVAL_MS=500
readonly GATAN_MAIN_REFRESH_INTERVAL_MS=300
readonly GATAN_INPUT_POLL_INTERVAL_MS=50
readonly GATAN_INPUT_POLL_INTERVAL_SECONDS=0.05
readonly GATAN_MAIN_FRAME_OVERHEAD=6
